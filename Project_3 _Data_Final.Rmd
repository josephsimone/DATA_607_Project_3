...
```{r, include=TRUE }
imgage <- "https://raw.githubusercontent.com/josephsimone/DATA_607_Project_3/master/journal.PNG"
include_graphics(imgage)
```
```{r, echo=FALSE}
url <- "https://raw.githubusercontent.com/josephsimone/DATA_607_Project_3/master/journal.PNG"
```
...
```{r, include=TRUE }
imgage <- "https://raw.githubusercontent.com/josephsimone/DATA_607_Project_3/master/kaggle.PNG"
include_graphics(imgage)
```


```{r, echo=FALSE}
url <- "https://raw.githubusercontent.com/josephsimone/DATA_607_Project_3/master/kaggle.PNG"
```
...
```{r, include=TRUE }
imgage <- "https://github.com/josephsimone/DATA_607_Project_3/blob/master/kaggle_data.PNG"
include_graphics(imgage)
```


```{r, echo=FALSE}
url <- "https://raw.githubusercontent.com/josephsimone/DATA_607_Project_3/master/kaggle_data.PNG"
```
